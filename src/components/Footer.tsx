      ...
      <div className="max-w-[1600px] mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex gap-4 mt-6">
            <a href="https://instagram.com/priestessofthesoul" target="_blank" rel="noreferrer" aria-label="Instagram" className="text-[#fffef2]/50 hover:text-[#fffef2] transition-colors">
            ...
            <a href="https://tiktok.com/@priestessofthesoul" target="_blank" rel="noreferrer" aria-label="TikTok" className="text-[#fffef2]/50 hover:text-[#fffef2] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
