        ...
        html: `
          <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 32px; color: #201616;">
            ...
            <table style="width:100%; border-collapse: collapse; margin-bottom: 24px;">
              ...
              <tr style="background:#f6f5e9"><td style="padding:10px 14px; font-size:12px; text-transform:uppercase; letter-spacing:2px; color:#888;">Emri</td><td style="padding:10px 14px;">${name}</td></tr>
              <tr><td style="padding:10px 14px; font-size:12px; text-transform:uppercase; letter-spacing:2px; color:#888;">Email</td><td style="padding:10px 14px;">${email}</td></tr>
              <tr style="background:#f6f5e9"><td style="padding:10px 14px; font-size:12px; text-transform:uppercase; letter-spacing:2px; color:#888;">Telefoni</td><td style="padding:10px 14px;">${phone}</td></tr>
              <tr><td style="padding:10px 14px; font-size:12px; text-transform:uppercase; letter-spacing:2px; color:#888;">Adresa</td><td style="padding:10px 14px;">${address}</td></tr>
