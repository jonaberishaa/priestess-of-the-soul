        ...
        <section className="py-16 px-6 bg-[#fffffc]">
          <div className="max-w-[1600px] mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-heading text-4xl md:text-5xl text-[#201616]">1 200+ Klientë të Lumtur</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { name: 'Drita M.', location: 'Tiranë', rating: 5, text: 'Kam blerë dy vathë dhe një gjerdan. Cilësia është e jashtëzakonshme, gurët janë të vërtetë dhe ndjehem si perëndeshë kur i vesh.' },
