...
export default function OrderConfirmationPage({
  ...
  return (
    <div className="min-h-screen bg-[#f6f5e9]">
      {/* Top bar */}
      <div className="bg-[#201616] px-6 py-4">
        <div className="max-w-[720px] mx-auto">
          <Link href="/" className="font-heading text-xl text-[#fffef2] tracking-wide">
      ...
      <div className="max-w-[720px] mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#201616] mb-6">
            <svg className="w-8 h-8 text-[#fffef2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-sm text-[#201616]/60 font-body">
            Porosia juaj u mor me sukses. Do të kontaktoheni së shpejti.
          </p>
        </div>

        {/* Rules */}
        <div className="bg-[#201616] p-8 mb-6">
          <p className="text-[10px] tracking-[0.3em] uppercase text-[#fffef2]/40 font-body mb-1">Para Dorëzimit</p>
          <h2 className="font-heading text-2xl text-[#fffef2] mb-6">Porosia juaj është konfirmuar</h2>
          <ul className="flex flex-col gap-4">
            {rules.map((rule, i) => (
              <li key={i} className="flex items-start gap-4">
                <span className="flex-shrink-0 w-6 h-6 bg-[#b31b1b] text-[#fffef2] text-[10px] font-bold flex items-center justify-center mt-0.5">
                  {i + 1}
                </span>
                <p className="text-sm text-[#fffef2]/80 font-body leading-relaxed">{rule}</p>
              </li>
            ))}
          </ul>
          <p className="text-sm text-[#fffef2]/60 font-body mt-6 pt-6 border-t border-[#fffef2]/10 italic">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            href="/dyqan"
            className="flex-1 text-center bg-[#201616] text-[#fffef2] py-4 text-xs tracking-[0.25em] uppercase font-body hover:bg-[#b31b1b] transition-colors"
          >
            Vazhdo Blerjet
          </Link>
          <Link
