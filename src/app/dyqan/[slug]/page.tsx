        ...
        <div className="max-w-content mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="bg-burgundy text-white text-[10px] tracking-widest uppercase px-2 py-1">-20%</span>
              <p className="text-2xl text-burgundy">€{Math.round(parseFloat(product.price.replace(/[^0-9.]/g, '')) * 0.8)}</p>
